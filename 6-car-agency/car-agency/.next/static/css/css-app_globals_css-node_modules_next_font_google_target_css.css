...
.bg-primary-blue{
  --tw-bg-opacity: 1;
  background-color: rgb(43 89 255 / var(--tw-bg-opacity));
}
.object-contain{
  object-fit: contain;
}
...
.hero__subtitle{
  ...
  font-weight: 300;
  --tw-text-opacity: 1;
  color: rgb(43 44 53 / var(--tw-text-opacity));
}
...
.car-card__icon-container{
  ...
  justify-content: space-between;
  --tw-text-opacity: 1;
  color: rgb(116 122 136 / var(--tw-text-opacity));
}
...
.search-manufacturer__options:focus{
  outline: 2px solid transparent;
  outline-offset: 2px;
}
