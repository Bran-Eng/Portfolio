...
const Footer = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('brandon.se.25@gmail.com');
    setCopied(true);
          ...
          <div className='w-full h-full flex flex-row items-start justify-around flex-wrap'>
            ...
            <div className='min-w-[200px] h-auto flex flex-col items-center justify-start'>
              ...
              <div className='flex flex-row items-center my-[15px] cursor-pointer relative'>
                <a
                  href='mailto:brandon.se.25@gmail.com'
                  className='text-[15px] ml-[6px]'>
                  brandon.se.25@gmail.com
                </a>
                <FaCopy
                  className='ml-[10px] text-[15px] cursor-pointer'
                  onClick={handleCopy} // Attach the click handler
                />
                {copied && (
                  <div className='absolute flex items-center left-[215px] ml-[5px] text-[12px] text-green-500'>
